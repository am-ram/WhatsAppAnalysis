...
st.markdown('<strong style="font-size:45px">Whatsapp Group Chat Analysis</strong>',unsafe_allow_html=True)
st.markdown('<p style="font-size:30px">Ever wondered of the insights your group could provide ?</p>',unsafe_allow_html=True)
st.set_option('deprecation.showfileUploaderEncoding', False)

st.sidebar.title("Analyze:")
st.sidebar.markdown("This app is use to analyze your WhatsApp Group Chats")

st.sidebar.markdown('This is a WebApp created by Sai Ram.K. The link to my GitHub Repository can be found [here](https://github.com/am-ram). ')
...
st.sidebar.text('4. Upload the file here towards the right.')
...
st.sidebar.markdown("** Currently works only for text files having date format as dd/mm/yy**")
